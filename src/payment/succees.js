    ...
    try{
        ...
        await axios({
            ...
            if( statuses === "SETTLED" || statuses === "PAID"){
                ...
                await Clientdb.query('Insert into "License" ("version", "status", "type", "userprofile_id", "typelicense_id", "invoice_id") values ($1, $2, $3, $4, $5, $6)', [ version, 'ACTIVE', 'PRO', getIdUser, types.rows[0].id, getInvoiceId])
