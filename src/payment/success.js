...
const getSuccess = async (req, res) => {
    ...
    try{
        ...
        const getDataId = await Clientdb.query('SELECT * FROM "UserProfile" where email like $1',[emailUser])
        ...
        await axios({
            ...
            if( statuses === "SETTLED"){
                ...
                await Clientdb.query('Insert into "License" ("valid_from", "valid_to", "status", "type", "userprofile_id", "typelicense_id", "invoice_id") values ($1, $2, $3, $4, $5, $6, $7)', [ getDateNow, setDateThen, stat,'PRO', getIdUser, types.rows[0].id, getInvoiceId])
